...
import { phoneNumber, emailId, studioAddress } from '../constant';
    ...
    <section id="contact" className="py-20 bg-gray-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          ...
          <p className="text-gray-600">Let's discuss your next project or special event</p>
        </div>
          ...
          <div className="space-y-8">
            ...
            <div className="flex items-start space-x-4">
              ...
              <div>
                ...
                <p className="text-gray-600" dangerouslySetInnerHTML={{__html: studioAddress}}></p>
              </div>
            </div>
          </div>
